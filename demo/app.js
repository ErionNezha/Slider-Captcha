...
(function () {
  ...
  t.DEFAULTS = {
      ...
      failedText: "Provo p\u00ebrs\u00ebri",
      barText: "Rr\u00ebshqit djathtas p\u00ebr t\u00eb plot\u00ebsuar pjes\u00ebn",
      repeatIcon: "",
      maxLoadCount: 3,
  ...
  n.initImg = function () {
      ...
      t.setSrc = function () {
          ...
          (r && r !== "") ||
              (r = "images/pic" + (1 + Math.floor(Math.random() * 5)) + ".jpg");
          f
...
var captcha = sliderCaptcha({
  ...
  onSuccess: function () {
    ...
    // }, 500);
      setTimeout(function () {
          alert('Captcha u verifikua me sukses! ✓');
          captcha.reset();
       }, 1000);
    },
  setSrc: function () {
       return 'images/pic' + (1 + Math.floor(Math.random() * 5)) + '.jpg';
  },
});
